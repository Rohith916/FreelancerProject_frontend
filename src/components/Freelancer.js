...
import '../style/Find.css'
  ...
  export default function Find() {
      ...
      const filteredData = data.filter((freelancer) => {
        const skillsLowerCase = freelancer.skills.toLowerCase().split(',').map(skill => skill.trim());
        return skillsLowerCase.some((skill) => skill.includes(searchTerm.toLowerCase()));
    });
